...
function broInit(id) {
  $.getJSON('<?php print url('v1/'. $bro->id .'/bro/html', array('query' => 'callback=?', 'absolute' => TRUE)); ?>', function(data) {
    var o = {
      name: 'broDependencies',
      js: data.js_deps,
      success: function() {
        var o = {};
        o.css = data.css;
        ...
        o.success = function() {
          ...
          $('#bro-main').sonyBro(data.settings);
        };
        $.xLazyLoader(o);
      }
    };
