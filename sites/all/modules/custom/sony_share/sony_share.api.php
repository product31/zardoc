...
/**
 * @file
 * Provides documentation for the sony share API.
 */

/**
 * Obtains all available sony share.
 * @return
 *   An array containing all sony share, keyed by name.
 */
function hook_sony_share() {
  $links = array();
...
/**
 * Example callback from the sony share.
 *
 * @param $service
...
/**
 * Allows alteration of the sony share.
 *
 * @param $links
 *   The constructed array of sony share.
 */
function hook_sony_share_alter(&$links) {
